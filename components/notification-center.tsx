...
export function NotificationCenter() {
  ...
  return <>
    <div className="relative">
      ...
      {open ? <div className="fixed inset-x-3 top-16 z-50 max-h-[calc(100dvh-5rem)] overflow-hidden rounded-2xl border border-slate-200 bg-white p-3 shadow-soft-lg sm:absolute sm:inset-x-auto sm:right-0 sm:top-12 sm:w-[360px]">
